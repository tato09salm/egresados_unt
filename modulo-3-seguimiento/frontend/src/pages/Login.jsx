...
export default function Login() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      // Uses modulo-1 auth replicado en modulo-3
  ...
  return (
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', background:'linear-gradient(135deg,#1a365d 0%,#744210 100%)' }}>
      <div style={{ background:'#fff', borderRadius:16, padding:40, width:'100%', maxWidth:420, boxShadow:'0 20px 60px rgba(0,0,0,.3)' }}>
        <div style={{ textAlign:'center', marginBottom:28 }}>
          ...
          <h2 style={{ fontSize:24, fontWeight:700, color:'#1a365d' }}>Seguimiento de Empleabilidad</h2>
          <p style={{ color:'#718096', fontSize:13 }}>SGE-UNT</p>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <button style={{ width:'100%', padding:12, background:'#744210', color:'#fff', border:'none', borderRadius:8, fontSize:15, fontWeight:600, cursor:'pointer', marginTop:16 }} disabled={loading}>
