    ...
    <div style={s.page}>
      <div style={s.body}>
        <div style={{ display:'flex', gap:12, marginBottom:20 }}>
          <button style={{...s.btn, background:'#1a365d'}} onClick={() => navigate('/mi-mentoria')}>📁 Mi Mentoría</button>
          <button style={{...s.btn, background:'#1a365d'}} onClick={() => navigate('/dashboard-mentor')}>🤝 Panel Mentor</button>
        </div>
